    ...
    def metadata(self) -> PDEMetadata:
        return PDEMetadata(
            ...
            parameters=[
                ...
                PDEParameter("C", "Damping/stabilization coefficient"),
            ],
            num_fields=2,
            field_names=["u", "v"],
...
class InhomogeneousWavePDE(MultiFieldPDEPreset):
    ...
    def metadata(self) -> PDEMetadata:
        return PDEMetadata(
            ...
            parameters=[
                PDEParameter("D", "Base diffusivity (wave speed squared)"),
                PDEParameter("E", "Amplitude of spatial variation (|E| < 1)"),
                PDEParameter("m", "Spatial mode number in x direction"),
                PDEParameter("n", "Spatial mode number in y direction"),
                PDEParameter("C", "Damping/stabilization coefficient"),
            ],
            num_fields=2,
            field_names=["u", "v"],
