        ...
        return PDEMetadata(
            ...
            parameters=[
                PDEParameter(
                    name="tau",
                    default=1.0,
                    description="Relaxation time (memory parameter)",
                    min_value=0.0,
                    max_value=2.0,
                ),
                PDEParameter(
                ...
                PDEParameter(
                    name="a",
                    default=5.0,
                    description="Brusselator feed rate",
                    min_value=1.0,
                    max_value=10.0,
                ),
                PDEParameter(
                    name="b",
                    default=9.0,
                    description="Brusselator removal rate",
                    min_value=1.0,
                    max_value=20.0,
                ),
                PDEParameter(
                    name="eps",
                    default=0.001,
                    description="Numerical diffusion for velocity variables",
                    min_value=0.0,
                    max_value=0.1,
                ),
            ],
