...
class PotentialFlowImagesPDE(MultiFieldPDEPreset):
    ...
    def metadata(self) -> PDEMetadata:
        return PDEMetadata(
            ...
            parameters=[
                PDEParameter("strength", "Source strength"),
                PDEParameter("wall_x", "Wall position (x-coordinate fraction)"),
                PDEParameter("sigma", "Gaussian width for moving sources"),
                PDEParameter("omega", "Angular velocity for motion (rad/time)"),
                PDEParameter("amplitude", "Amplitude of oscillation or orbit radius"),
            ],
            num_fields=2,
            field_names=["phi", "s"],
